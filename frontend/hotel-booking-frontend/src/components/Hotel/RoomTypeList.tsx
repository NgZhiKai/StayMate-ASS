...
export const RoomTypeList: React.FC<Props> = ({ rooms, setRooms, hotelId }) => (
  <div className="space-y-6">
    ...
    <div className="space-y-4">
      {rooms.map((room, idx) => (
        <div key={idx} className="bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 shadow-md rounded-2xl p-6 flex flex-col md:flex-row md:items-center md:space-x-6 gap-4 hover:shadow-2xl transition-all duration-300 relative">
